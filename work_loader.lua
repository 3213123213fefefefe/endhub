...
local buildVersion = "menu-server-7"
...
local ok, result = pcall(function()
    ...
    local cycleURL = 'https://raw.githubusercontent.com/3213123213fefefefe/endhub/1db0dd34f438133a967af02ee033323ed51ab9bd/modules/server_cycle.lua'
    local cycleSource = game:HttpGet(cycleURL)
    loggedPrint('[EndHub Loader] server module pinned=1db0dd3 | direct events only')
